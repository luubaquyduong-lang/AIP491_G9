...
FILE_PATH = r"D:\ARTIFICIAL_INTELLIGENCE\KY_9\AIP491\AIP491_G9\Data\processed\data_final_sort_v2.txt"
OUTPUT_TXT = r"D:\ARTIFICIAL_INTELLIGENCE\KY_9\AIP491\AIP491_G9\Data\processed\data_final_sort_v2_output.txt"
...
# ==========================
# 3. Đọc file & tính token, lọc dòng
# ==========================
filtered_lines = []
too_long = []   # (nếu bạn vẫn muốn biết dòng nào > 512 tokens)
num_under_50 = 0
...
for i, line in enumerate(lines):
    text = " ".join(line.split())   # normalize space
    ...
    if n_count < 50:
        num_under_50 += 1
        continue  # bỏ, không ghi vào file mới

    # Nếu muốn theo dõi dòng > MAX_TOKENS
    if n_tokens > MAX_TOKENS:
        too_long.append((i + 1, n_tokens))

    # Giữ lại dòng hợp lệ
    filtered_lines.append(text)

print(f"🔹 Số dòng có count < 50 (bị xoá): {num_under_50}")
print(f"✅ Số dòng giữ lại (count ≥ 50): {len(filtered_lines)}")
...
print(f"💾 Đã lưu dữ liệu đã lọc ra: {OUTPUT_TXT}")
