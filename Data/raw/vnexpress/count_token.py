...
FILE_PATH = r"D:\duongluuba\AIP491_G9\Data\embeddings\data_final_4333.txt"
...
for i, line in enumerate(lines):
    ...
    n_count = len(line.split())
    records.append({"index": i + 1, "text": line, "tokens": n_tokens, 'count': n_count})
